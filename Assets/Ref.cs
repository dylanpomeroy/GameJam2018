...
namespace Assets
{
    public static class Ref
    {
        ...
        public static List<List<long>> FrameRepeatRanges = new List<List<long>>
        {
            ...
            new List<long>{ 1160, 1260 },
            new List<long>{ 1400, 0 },
            new List<long>{ 1080, 0 },
            new List<long>{ 1200, 180 },
        ...
        public static List<string> VideoFiles = new List<string>
        {
            ...
            Application.dataPath + "/video3.mp4",
            Application.dataPath + "/video3.mp4",
            Application.dataPath + "/BeginningOfLevel2.mov", // 5
            Application.dataPath + "/vchoiceA.mov",
            Application.dataPath + "/vchoiceB.mov",
            Application.dataPath + "/vchoiceC.mov",
            Application.dataPath + "/finished.mp4", // 9
            Application.dataPath + "/video3.mp4",
            Application.dataPath + "/video3.mp4",
            Application.dataPath + "/video3.mp4",
            Application.dataPath + "/video3.mp4",
